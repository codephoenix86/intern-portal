...
export const createSession = async (req, res) => {
    try {
        ...
        const session = await liveSessionService.createSession(req.user.userId, req.body);
...
export const getMentorSessions = async (req, res) => {
    try {
        ...
        const query = queryResult.success
            ? queryResult.data
            : { page: 1, limit: 10, type: "all", status: "all" };
        const result = await liveSessionService.getMentorSessions(req.user.userId, query);
...
export const getSessionById = async (req, res) => {
    try {
        ...
        const session = await liveSessionService.getSessionById(sessionId, req.user.userId);
...
export const updateSession = async (req, res) => {
    try {
        ...
        const session = await liveSessionService.updateSession(sessionId, req.user.userId, req.body);
...
export const completeSession = async (req, res) => {
    try {
        ...
        const session = await liveSessionService.completeSession(sessionId, req.user.userId);
...
export const joinSession = async (req, res) => {
    try {
        ...
        const result = await liveSessionService.joinSession(sessionId, req.user.userId, accessCode);
