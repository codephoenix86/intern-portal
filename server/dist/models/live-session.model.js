...
// ── Instance Methods ─────────────────────────────────
liveSessionSchema.methods.isFull = function () {
    return this.attendeeCount >= this.maxAttendees;
};
liveSessionSchema.methods.hasStudentJoined = function (studentId) {
    return this.attendees.some((id) => id.toString() === studentId);
};
...
liveSessionSchema.methods.markAsCancelled = async function (reason) {
...
//# sourceMappingURL=live-session.model.js.map