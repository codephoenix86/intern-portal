...
import { getDashboard, listJobs, getJob, postJob, patchJob, closeJob, listApplicants, patchApplication, getProfile, patchProfile, listNotifications, markNotificationRead, markAllNotificationsRead, } from "../controllers/recruiter-portal.controller.js";
const router = Router();
