      ...
      <div className="hidden lg:flex flex-1 gradient-primary items-center justify-center p-10">
        <div className="text-center text-primary-foreground max-w-md">
          ...
          <p className="text-primary-foreground/80">
            Whether you're seeking an internship, hiring talent, or mentoring students,
        ...
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            ...
            >
              ...
              <p
                className={`text-sm font-medium ${
                  role === "mentor" ? "text-primary" : "text-foreground"
                }`}
              >
                Mentor
              </p>
              <p className="text-xs text-muted-foreground">Train students</p>
            </button>
          </div>
